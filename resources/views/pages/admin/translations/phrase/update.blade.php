                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="word" class="form-control" name="word" placeholder="Word" value="{{$phrase->word}}">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <div class="tab-content pt-1">
                                        @if(isset($languages))
                                              @foreach($languages as $key=>$language)
                                                ...
                                                @if(count($phrase->translations) === 0)
                                                ...
                                                @else
                                                    @foreach($phrase->translations as $key=>$translation)
                                                        ...
                                                        <div class="tab-pane {{$language->code === 'eng' ? 'active' : ''}}" id="{{$language->code}}-id" role="tabpanel" aria-labelledby="{{$language->code}}">
                                                            <div class="col-12">
                                                                <fieldset class="form-group" >
                                                                    ...
                                                                    <input type="text" class="form-control mb-1 d-none"  name="translations[{{$key}}][language_code]"  value="{{$translation->language_code ?? $language->code }}">
